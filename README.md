...
Full schedule in [`PLAN.md`](PLAN.md).
...
The two documents in [`docs/`](docs/) are the source of truth, the HTML spec winning any
disagreement. [`CLAUDE.md`](CLAUDE.md) carries the invariants and the hard numbers.
